                ...
                <div>
                    <table className="table">
                        <tbody>
                            ...
                            <tr className="text-danger">
                                <td colSpan={3}>
                                    <label>政府信息公开选项：<span style={{ color: 'black' }}>{formContext.watch('govPublicItem')}</span></label>
                                    <br />
                                    <label>{formContext.watch('govPublicItem')}的理由选项：{formContext?.watch('govPublicItemReason')}</label>
                                </td>
                            </tr>
